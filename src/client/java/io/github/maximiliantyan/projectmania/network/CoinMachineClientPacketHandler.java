...
public class CoinMachineClientPacketHandler {
    ...
    public static void receiveGameStartPacket(
        ...
        if (minecraft.screen instanceof CoinMachineScreen screen) {
            ...
            ModClient.LOGGER.warn("Coin Machine: Start packet: invalid screen {}", minecraft.screen);
        }
    }
    ...
    public static void receiveWheelStepPacket(
        ...
        if (minecraft.player == null) {
            ModClient.LOGGER.warn("Coin Machine: Wheel Step packet: Player is null");
            return;
        }
    ...
    public static void receiveWheelStopPacket(
        ...
        if (minecraft.player == null) {
            ModClient.LOGGER.warn("Coin Machine: Wheel Stop packet: Player is null");
            return;
        }
    ...
    public static void receiveWinPacket(
        ...
        if (minecraft.player == null) {
            ModClient.LOGGER.warn("Coin Machine: Win packet: Player is null");
            return;
        }
        ...
        if (minecraft.screen instanceof CoinMachineScreen screen) {
            ...
            ModClient.LOGGER.warn("Coin Machine: Win packet: invalid screen {}", minecraft.screen);
        }
    }
    ...
    public static void receiveLosePacket(
        ...
        if (minecraft.player == null) {
            ModClient.LOGGER.warn("Coin Machine: Lose packet: Player is null");
            return;
        }
        ...
        if (minecraft.screen instanceof CoinMachineScreen screen) {
            ...
            ModClient.LOGGER.warn("Coin Machine: Lose packet: invalid screen {}", minecraft.screen);
        }
    }
