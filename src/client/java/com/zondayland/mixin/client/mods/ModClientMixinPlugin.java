package com.zondayland.mixin.client.mods;
...
public abstract class ModClientMixinPlugin implements IMixinConfigPlugin {
    ...
    public void onLoad(String mixinPackage) {
        modPresent = FabricLoader.getInstance().isModLoaded(getModId());
        if (modPresent) {
            ZondayLandClient.LOGGER.info("Loading {} mod mixins", getModName());
        } else {
            ZondayLandClient.LOGGER.warn("{} (id: '{}') mod is absent, disabling associated mixins",
                    getModName(),
                    getModId()
            );
        }
