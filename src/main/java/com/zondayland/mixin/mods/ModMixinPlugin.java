package com.zondayland.mixin.mods;
...
public abstract class ModMixinPlugin implements IMixinConfigPlugin {
    ...
    public void onLoad(String mixinPackage) {
        ...
        if (modPresent) {
            ZondayLand.LOGGER.info("Loading {} mod mixins", getModName());
        } else {
            ZondayLand.LOGGER.warn("{} (id: '{}') mod is absent, disabling associated mixins",
                    getModName(),
                    getModId()
            );
        }
